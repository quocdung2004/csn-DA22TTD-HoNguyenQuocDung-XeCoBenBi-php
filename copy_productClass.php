...
class product
{
    ...
    public function insert_lichBaoDuong()
    {
        ...
        $query = "INSERT INTO tbl_datlich (hoten, sdt, biensoxe, category_id, brand_id, product_id, ngaybd, product_price) 
            VALUES ('$hoten', '$sdt', '$biensoxe', '$category_id', '$brand_id', '$product_id', '$ngaybd', '$product_price')";
    ...
    public function show_datLich()
    {
        $query = "SELECT tbl_datlich.*, tbl_category.category_name, tbl_brand.brand_name, tbl_product.product_name
            ...
            ORDER BY tbl_datlich.datlich_id DESC;";
        $result = $this->db->select($query);
        return $result;
    }
